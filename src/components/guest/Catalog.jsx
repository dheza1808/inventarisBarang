...
export default function Catalog({ searchTerm }) {
	...
	return (
		<div className="relative px-6 mt-12">
			...
			<div
				ref={scrollRef}
				className="overflow-x-auto scroll-smooth whitespace-nowrap px-8 scrollbar-hide"
			>
					...
					{filteredItems.length > 0 ? (
						filteredItems.map((item) => (
							...
							>
								...
								/>
								<div
									className="p-2 text-center text-sm font-medium text-gray-800 truncate w-full"
									title={item.nama}
								>
									{" "}
									{item.nama}
